...
const Position = {
	...
	desc: (<div className='section-body-fragment'>
		...
		<div>Like <span className='third-party'>Bootstrap</span>, <span className='keyword'>n-col-push-*</span>, <span className='keyword'>n-col-pull-*</span> and <span className='keyword'>n-col-offset-*</span> are supported. They can be added via <span className='keyword'>width</span> or <span className='keyword'>clear</span>.</div>
